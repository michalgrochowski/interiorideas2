...
$(window).on("scroll touchmove", function () {
    $('.nav').toggleClass("nav--small", $(document).scrollTop() > 100);
    $('.nav__logo').toggleClass("nav__logo--small", $(document).scrollTop() > 100);
...
/* Check each input if it's valid and if so, send a form using AJAX and show a respose to the user */
